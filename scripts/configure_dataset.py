...
seq_lengths = SeqLengths(
    lengths={
        ...
        'neg' : {
            'support' : TensorConfig.from_tensor(torch.arange(0, 2)),
            'pmf' : TensorConfig.from_tensor(data_utils.uniform_pmf(2))
        }
    }
)
...
# reconstructed_data_cfg = serialization_utils.deserialize(data_cfg_filepath)

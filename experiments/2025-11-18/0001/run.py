...
# ----------------------------- Set run args -------------------------------- #
run_args = dict(
    data_train_cfg_ref_list=['2025-10-23/o/0000'],
    model_cfg_ref_list=['2025-11-18/a/0001'],
    pretrained_model_filepath_list=None,
    training_cfg_ref_list=['2025-09-16/z/0000'],
    data_test_cfg_ref_list=['2025-10-23/o/0000', '2025-10-23/e/0000'],
    cross_test=True,
...
metadata_utils.create_textfile(
    """
    Like 2025-11-18/0000 but with recurrent weights scaled down by 0.01 compared
    to default initialization. Again, task has context-dependence. Train on odd, 
    test on even.
    """,
